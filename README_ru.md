...
- [GPT Image 2 Gen Skill](https://github.com/Evolink-AI/GPT-Image-2-Seedance2-Workflow) добавляет вашему агенту генерацию и редактирование изображений через GPT Image 2
- [Seedance 2 Video Gen Skill](https://github.com/Evolink-AI/Seedance-2.0-Gateway-Service) добавляет вашему агенту генерацию видео через Seedance 2
