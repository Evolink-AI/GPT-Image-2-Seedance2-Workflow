...
- [GPT Image 2 Gen Skill](https://github.com/Evolink-AI/GPT-Image-2-Seedance2-Workflow) は、Agent に GPT Image 2 の画像生成と編集機能を追加します
- [Seedance 2 Video Gen Skill](https://github.com/Evolink-AI/Seedance-2.0-Gateway-Service) は、Agent に Seedance 2 の動画生成機能を追加します
...
<table><tr>
<td align="center"><a href="https://evolink.ai/launch/seedance-2-5?utm_source=github&utm_medium=picture&utm_campaign=gptimage2-x-seedance2"><img src="images/character_case12/output.jpg" width="400" alt="Claude Code + GPT Image 2 キャラクターキービジュアル"></a></td>
</tr></table>
